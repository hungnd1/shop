...
class ReportSubscriberDaily extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['report_date', 'site_id','dealer_id', 'service_id', 'total_subscriber', 'total_active_subscriber', 'subscriber_register_daily', 'total_cancel_subscriber', 'subscriber_cancel_daily'], 'integer']
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'service_id' => 'Gói cước',
            'total_subscriber' => 'Tổng thuê bao đăng ký',
            'total_active_subscriber' => 'Thuê bao đang hoạt động',
            'subscriber_register_daily' => 'Thuê bao đăng ký mới',
            'total_cancel_subscriber' => 'Tổng thuê bao hủy',
            'subscriber_cancel_daily' => 'Thuê bao hủy',
        ];
    }
