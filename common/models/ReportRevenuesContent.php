...
class ReportRevenuesContent extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'site_id' => 'Service Provider',
            'content_revenues' => 'Mua nội dung lẻ (VND)',
            'register_revenues' => 'Đăng ký (VND)',
            'renew_revenues' => 'Gia hạn (VND)',
            'total_revenues' => 'Tổng (VND)',
            'buy_content_number' => 'Luợt mua lẻ',
        ];
    }
}
