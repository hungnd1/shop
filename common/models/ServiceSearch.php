...
//    public $auto_renew = Service::TYPE_AUTO_RENEW;
    ...
    {
        return [
            [['id', 'site_id', 'status', 'created_at', 'updated_at', 'free_download_count', 'free_duration', 'free_view_count', 'free_gift_count', 'period', 'auto_renew', 'free_days', 'max_daily_retry', 'max_day_failure_before_cancel', 'root_service_id'], 'integer'],
