...
class ReportSubscriberDailySearch extends ReportSubscriberDaily
{
    ...
    {
        return [
            [['id', 'report_date', 'site_id','dealer_id', 'service_id', 'total_subscriber', 'total_active_subscriber', 'subscriber_register_daily', 'total_cancel_subscriber', 'subscriber_cancel_daily'], 'integer'],
