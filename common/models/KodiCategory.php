...
class KodiCategory extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [[ 'display_name','image'], 'required', 'message' => '{attribute} không được để trống', 'on' => 'admin_create_update'],
            [
                [
                    'status',
                    'created_at',
...
//                    }
    ...
    {
        $res = '';
        $category = KodiCategory::findOne(['status'=>KodiCategory::STATUS_ACTIVE,'id'=>$this->id]);
