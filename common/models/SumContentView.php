...
/**
 * This is the model class for table "{{%sum_content_view}}".
 *
 * @property integer $id
 ...
 */
class SumContentView extends \yii\db\ActiveRecord
{
    const TYPE_VIDEO = 1;
    const TYPE_LIVE = 2;
    const TYPE_MUSIC = 3;
    ...
    public function rules()
    {
        return [
            ...
            [['content_id', 'site_id', 'content_provider_id', 'view_count', 'is_free', 'type', 'created_at', 'updated_at'], 'integer'],
            [['amount'], 'number'],
            [['report_date'], 'safe']
        ];
    }
