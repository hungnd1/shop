...
class ActorDirector extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['name'], 'string', 'max' => 200,'tooLong' =>  '{attribute} giới hạn 200 ký tự'],
            [['name'], 'required', 'message' => '{attribute} không được phép để trống' ],
...
//            ['image', 'file', 'extensions' => 'jpg,png,gif,jpeg','maxSize' => 1024 * 1024 * 10,'tooBig' => 'File ảnh vượt quá dung lượng cho phép. Vui lòng thử lại.'],
            ['image', 'file',
                ...
                'wrongExtension' => 'File ảnh không đúng định dạng',
            ],
            ['image', 'file', 'maxSize' => 1024 * 1024 * 10,'tooBig' => 'File ảnh vượt quá dung lượng cho phép. Vui lòng thử lại.'],
...
//            ],
    ...
    {
        $lst = [
            self::TYPE_DIRECTOR => $content_type==ActorDirector::TYPE_VIDEO?'Đạo diễn':'Nhạc sĩ',
            self::TYPE_ACTOR => $content_type==ActorDirector::TYPE_VIDEO?'Diễn viên':'Ca sĩ',
        ];
        return $lst;
