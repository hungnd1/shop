...
class SmsMoSyntax extends \yii\db\ActiveRecord
{
    ...
    public static $mo_status = [
        self::STATUS_ACTIVE => 'Kích hoạt',
        self::STATUS_PENDING => 'Chờ duyệt',
        self::STATUS_PAUSE => 'Tạm dừng',
        self::STATUS_INACTIVE => 'Loại bỏ',
    ];
    ...
    public static $mo_events = [
        self::MO_EVENT_REGISTER => 'Đăng ký',
        self::MO_EVENT_CANCEL => 'Hủy',
        self::MO_EVENT_HELP => 'Tra cứu',
        self::MO_EVENT_PASSWORD => 'Mật khẩu',
        self::MO_EVENT_CHARGE_COIN => 'Nạp coin',
    ];
    ...
    {
        $status = [];
        foreach (self::$mo_status as $id => $des) {
