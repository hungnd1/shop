                ...
                <div class="form-actions">
                    <div class="row">
                        <div class="col-md-offset-3 col-md-9">
                            <?= Html::a('Cập nhật', ['update', 'id' => $model->id,'content_type' => $content_type], ['class' => 'btn btn-primary']) ?>
                            <?= Html::a('Hủy thao tác', ['index','content_type' => $content_type], ['class' => 'btn btn-default']) ?>
                        </div>
                    </div>
                </div>
            </div>
