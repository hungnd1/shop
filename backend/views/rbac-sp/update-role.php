...
$this->params['breadcrumbs'][] = ['label' => 'Quản lý nhóm quyền trang đại lý', 'url' => ['role']];
...
<div class="row">
    ...
    $revokeUrl = \yii\helpers\Url::to(['rbac-sp/role-revoke-auth-item']);
        ...
        <div class="portlet box green">
            ...
            <div class="portlet-body">
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'value' => function ($model, $key, $index, $widget) {
                                 ...
                                 * @var $model \common\models\AuthItem
                                 */
                                $action = $model->type == \common\models\AuthItem::TYPE_ROLE?'rbac-sp/update-role':'rbac-sp/update-permission';
                ...
                $form = ActiveForm::begin([
                    'id' => $formID,
                    'action' => ['rbac-sp/role-add-auth-item', 'name' => $model->name]
                ]);
                ?>
