...
$this->params['breadcrumbs'][] = ['label' => 'Quản lý nhóm quyền nhà cung cấp dịch vụ', 'url' => ['role']];
...
<div class="row">
    ...
    $revokeUrl = \yii\helpers\Url::to(['rbac-cp/role-revoke-auth-item']);
        ...
        <div class="portlet box green">
            ...
            <div class="portlet-body">
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'value' => function ($model, $key, $index, $widget) {
                                 ...
                                 * @var $model \common\models\AuthItem
                                 */
                                $action = $model->type == \common\models\AuthItem::TYPE_ROLE?'rbac-cp/update-role':'rbac-cp/update-permission';
                ...
                $form = ActiveForm::begin([
                    'id' => $formID,
                    'action' => ['rbac-cp/role-add-auth-item', 'name' => $model->name]
                ]);
                ?>
