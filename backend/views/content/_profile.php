...
<input type="text" class="form-control input-circle col-md-6" id="search_file" placeholder="Tìm nội dung đã transcode ..."></input>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <?= $form->field($profile, 'subtitle')->fileInput() ?>
                    ...
                    <?= $form->field($profile, 'type')->dropDownList(\common\models\ContentProfile::$types,
                        ['class' => 'input-circle']) ?>
...
JS;
 ...
 //         'maxNumberOfFiles' => 1,
 // //        'acceptFileTypes' => "RegExp('/(\.|\/)(gif|jpe?g|png)$/i')",
 //     ],
 //     'clientEvents' => [
