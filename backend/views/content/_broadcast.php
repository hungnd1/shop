...
$('#checkBtn').click(function(e){
    ...
    if(!checking){
        ...
        if(checkResult){
            ...
            $('#checker .help-block').html("Lịch phát sóng sai định dạng");
        }
        ...
        $('#checker').hide();
        checking = false;
        $('#checkBtn').text('Kiểm tra lịch phát sóng');
    }
...
$('#submit').click(function(e){
    ...
    if($('#liveprogram-date').val() === ""){
        ...
        $( "<p>Ngày phát sóng không được để trống</p>" ).css('color', 'red').insertAfter( '#liveprogram-date' )
        checkResult = false;
    }else{
    ...
    if($('#live_content').val() === ""){
        ...
        $( "<p>Lịch phát sóng không được để trống</p>" ).css('color', 'red').insertAfter( '#live_content' )
    }else{
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Tạo lịch phát sóng</h4>
            </div>
            <div class="modal-body">
                ...
                <div class="form-group field-live_content" id="checker" style="display: none;">
                    <label class="control-label col-sm-3" for="live_content">Lịch phát sóng</label>
                ...
                <div class="row">
                    <div class="col-md-offset-3 col-md-9">
                        <?= Html::submitButton('Thêm lịch phát sóng', ['class' => 'btn btn-success', 'id' => 'submit']) ?>
                        <?= Html::a('Kiểm tra lịch phát sóng', '', ['class' => 'btn btn-warning', 'id' => 'checkBtn']) ?>
                    </div>
                </div>
                <?php ActiveForm::end(); ?>
            </div>
...
<?php
echo Html::button('Tạo lịch phát sóng',
    [
        'data-toggle' => 'modal',
        ...
        [
            ...
            'editableOptions' => function ($model, $key, $index) {
                return [
                    'header' => 'Status',
                    'size' => 'md',
                    'displayValueConfig' => \common\models\LiveProgram::$listStatus,
                    'inputType' => \kartik\editable\Editable::INPUT_DROPDOWN_LIST,
                    'placement' => \kartik\popover\PopoverX::ALIGN_LEFT,
                    'data' => \common\models\LiveProgram::$listStatus,
                    'formOptions' => [
