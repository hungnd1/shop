...
$treeID = 'video_category_tree_'.$model->id;
$buttonID = 'update_cate_video_'.$model->id;

if ($readOnly) {
    $js = <<<JS
    function handleVideoCategoryUpdate{$treeID}(e){
        e.preventDefault();
...
JS;
    ...
    $this->registerJs("$('#{$buttonID}').click(handleVideoCategoryUpdate$treeID);", \yii\web\View::POS_READY);
}
