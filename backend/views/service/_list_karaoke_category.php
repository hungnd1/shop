...
$treeID = 'karaoke_category_tree_'.$model->id;
$buttonID = 'update_cate_karaoke_'.$model->id;

if ($readOnly) {
    $js = <<<JS
    function handleKaraokeCategoryUpdate{$treeID}(e){
        e.preventDefault();
...
JS;
    ...
    $this->registerJs("$('#{$buttonID}').click(handleKaraokeCategoryUpdate$treeID);", \yii\web\View::POS_READY);
}
