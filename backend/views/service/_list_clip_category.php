...
$treeID = 'clip_category_tree_'.$model->id;
$buttonID = 'update_cate_clip_'.$model->id;

if ($readOnly) {
    $js = <<<JS
    function handleClipCategoryUpdate{$treeID}(e){
        e.preventDefault();
...
JS;
    ...
    $this->registerJs("$('#{$buttonID}').click(handleClipCategoryUpdate$treeID);", \yii\web\View::POS_READY);
}
