...
$treeID = 'radio_category_tree_'.$model->id;
$buttonID = 'update_cate_radio_'.$model->id;

if ($readOnly) {
    $js = <<<JS
    function handleRadioCategoryUpdate{$treeID}(e){
        e.preventDefault();
...
JS;
    ...
    $this->registerJs("$('#{$buttonID}').click(handleRadioCategoryUpdate$treeID);", \yii\web\View::POS_READY);
}
