...
$this->title = $title;
$this->params['breadcrumbs'][] = ['label' => 'Danh sách nhà cung cấp dịch vụ', 'url' => ['service-provider/index']];
$this->params['breadcrumbs'][] = ['label' => $sp->name, 'url' => ['service-provider/view', 'id' => $sp->id]];
        ...
        <div class="portlet light">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green-sharp bold uppercase">Chi tiết gói cước : <?php echo $title;?></span>
                </div>
                <div class="tools">
