...
$treeID = 'live_category_tree_'.$model->id;
$buttonID = 'update_cate_live_'.$model->id;

if ($readOnly) {
    $js = <<<JS
    function handleLiveCategoryUpdate{$treeID}(e){
        e.preventDefault();
...
JS;
    ...
    $this->registerJs("$('#{$buttonID}').click(handleLiveCategoryUpdate$treeID);", \yii\web\View::POS_READY);
}
