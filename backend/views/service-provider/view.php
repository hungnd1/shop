...
$this->params['breadcrumbs'][] = ['label' => 'Nhà cung cấp dịch vụ', 'url' => ['index']];
        ...
        <div class="portlet light">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green-sharp bold uppercase">Nhà cung cấp dịch vụ : <?php echo $model->name;?></span>
                </div>
                <div class="tools">
