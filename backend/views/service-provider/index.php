...
$this->title = 'Quản lý Nhà cung cấp dịch vụ';
        ...
        <div class="portlet light">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span
                        class="caption-subject font-green-sharp bold uppercase">Quản lý Nhà cung cấp dịch vụ</span>
                </div>
                <div class="tools">
            ...
            <div class="portlet-body">
                <p>
                    <?= Html::a("Tạo Nhà cung cấp dịch vụ " ,
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'value' => function ($model, $key, $index, $widget) {
                                 ...
                                 * @var $model \common\models\Site
                                 */
                                return \common\models\Site::$sp_status[$model->status];
                            },
                            'filterType' => GridView::FILTER_SELECT2,
                            'filter' => Site::$sp_status,
                            'filterWidgetOptions' => [
                        ...
                        [
                            ...
                            'buttons' => [
                                'transfer' => function ($url, $model, $key){
                                    ...
                                    return Html::a('<span class="glyphicon glyphicon-star"></span>', '#streaming-server-view', ['title' => 'Phân phối nội dung', 'data-toggle' => 'modal', 'data-backdrop' => "static", 'data-keyboard' => "false", 'onclick' => "js:loadModalData('$modalStreamingServer');"]);
                                }
                            ]
//                            'dropdown' => true,
                        ],
