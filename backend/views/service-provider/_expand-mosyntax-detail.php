...
<div class="caption">
    ...
    <span class="caption-subject font-white-sharp bold uppercase">Ghi chú</span>
</div>
...
<?= DetailView::widget([
    ...
    'attributes' => [
        ...
        [
            'attribute' => 'status',
            'value' => (isset(SmsMoSyntax::$mo_status[$model->status]))?SmsMoSyntax::$mo_status[$model->status]:'N/A'
        ],
        [
