                ...
                <?= DetailView::widget([
                    ...
                    'attributes' => [
                        ...
                        [
                            ...
                            'format'=>'raw',
                            'value'=>Html::a(($model->defaultContentPrice)?"Chi tiết":"N/A", ($model->defaultContentPrice)?\yii\helpers\Url::to(['pricing/view','id' => $model->defaultContentPrice->id]):"#", ['class'=>'kv-author-link']),
                        ],
                        [
                            'attribute'=>'currency',
                            'format'=>'raw',
                        ...
                        [
                            'attribute' => 'status',
                            'value' => \common\models\Site::$sp_status[$model->status]
                        ],
