...
class RbacCpController extends \yii\web\Controller
{
...
//            'searchModel' => $searchModel
    ...
    public function actionCreateRole()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            if (!$model->save()) {
                ...
                \Yii::$app->getSession()->setFlash('success', 'Tạo thành công');
    ...
    public function actionGeneratePermission()
    {
        $dataProvider = new ArrayDataProvider([
            'allModels' => AuthHelper::listActions('@dealer', true),
            'key' => 'name',
            'pagination' => [
                'pageSize' => 50,
            ],
...
//
    ...
    {
        $dataProvider = new ArrayDataProvider([
            'allModels' => AuthHelper::listControllers('@dealer', true),
            'key' => 'name',
            'pagination' => [
                'pageSize' => 50,
            ],
...
//
    ...
    public function actionGeneratePermissionConfirm(){
        ...
        if (isset($post['ids'])) {
            $ids = $post['ids'];
            $actions = AuthHelper::listActions('@dealer', true);
    ...
    public function actionGenerateRoleConfirm(){
        ...
        if (isset($post['ids'])) {
            $ids = $post['ids'];
            $controllers = AuthHelper::listControllers('@dealer', true);//FIXME: cuongvm 20150326 -  fixbug không tự add full. false->true
