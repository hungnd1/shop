            ...
            <div class="column col-xs-12 col-sm-3" id="left_column">
                        ...
                        <div class="owl-carousel owl-best-sell" data-loop="true" data-nav = "false" data-margin = "0" data-autoplayTimeout="1000" data-autoplay="true" data-autoplayHoverPause = "true" data-items="1">
                            <ul class="products-block best-sell">
                                <li>
                                    <div class="products-block-left">
                                        <a href="#">
                                            <img src="<?= Yii::$app->getUrlManager()->getBaseUrl() ?>/data/product-100x122.jpg" alt="SPECIAL PRODUCTS">
                                        </a>
                                    </div>
                                ...
                                <li>
                                    <div class="products-block-left">
                                        <a href="#">
                                            <img src="<?= Yii::$app->getUrlManager()->getBaseUrl() ?>/data/p11.jpg" alt="SPECIAL PRODUCTS">
                                        </a>
                                    </div>
                                    <div class="products-block-right">
                                        <p class="product-name">
                                ...
                                <li>
                                    <div class="products-block-left">
                                        <a href="#">
                                            <img src="<?= Yii::$app->getUrlManager()->getBaseUrl() ?>/data/p12.jpg" alt="SPECIAL PRODUCTS">
                                        </a>
                                    </div>
                                    <div class="products-block-right">
                                        <p class="product-name">
                            ...
                            <ul class="products-block best-sell">
                                <li>
                                    <div class="products-block-left">
                                        <a href="#">
                                            <img src="<?= Yii::$app->getUrlManager()->getBaseUrl() ?>/data/p13.jpg" alt="SPECIAL PRODUCTS">
                                        </a>
                                    </div>
                                    <div class="products-block-right">
                                        <p class="product-name">
                                ...
                                <li>
                                    <div class="products-block-left">
                                        <a href="#">
                                            <img src="<?= Yii::$app->getUrlManager()->getBaseUrl() ?>/data/p14.jpg" alt="SPECIAL PRODUCTS">
                                        </a>
                                    </div>
                                    <div class="products-block-right">
                                        <p class="product-name">
                                ...
                                <li>
                                    <div class="products-block-left">
                                        <a href="#">
                                            <img src="<?= Yii::$app->getUrlManager()->getBaseUrl() ?>/data/p15.jpg" alt="SPECIAL PRODUCTS">
                                        </a>
                                    </div>
                                    <div class="products-block-right">
                                        <p class="product-name">
                ...
                <div class="col-left-slide left-module">
                    <ul class="owl-carousel owl-style2" data-loop="true" data-nav = "false" data-margin = "0" data-autoplayTimeout="1000" data-autoplayHoverPause = "true" data-items="1" data-autoplay="true">
                        <li><a href="#"><img src="<?= Yii::$app->getUrlManager()->getBaseUrl() ?>/data/slide-left.jpg" alt="slide-left"></a></li>
                        <li><a href="#"><img src="<?= Yii::$app->getUrlManager()->getBaseUrl() ?>/data/slide-left2.jpg" alt="slide-left"></a></li>
                        <li><a href="#"><img src="<?= Yii::$app->getUrlManager()->getBaseUrl() ?>/data/slide-left3.png" alt="slide-left"></a></li>
                    </ul>
                </div>
                <!--./left silde-->
                <!-- block best sellers -->
                        ...
                        <ul class="product-list owl-carousel" data-loop="true" data-nav = "false" data-margin = "0" data-autoplayTimeout="1000" data-autoplayHoverPause = "true" data-items="1" data-autoplay="true">
                            <li>
                                <div class="product-container">
                                    <div class="left-block">
                                        <a href="#">
                                            <img class="img-responsive" alt="product" src="<?= Yii::$app->getUrlManager()->getBaseUrl() ?>/data/product-260x317.jpg" />
                                        </a>
                            ...
                            <li>
                                <div class="product-container">
                                    <div class="left-block">
                                        <a href="#">
                                            <img class="img-responsive" alt="product" src="<?= Yii::$app->getUrlManager()->getBaseUrl() ?>/data/p35.jpg" />
                                        </a>
                            ...
                            <li>
                                <div class="product-container">
                                    <div class="left-block">
                                        <a href="#">
                                            <img class="img-responsive" alt="product" src="<?= Yii::$app->getUrlManager()->getBaseUrl() ?>/data/p37.jpg" />
                                        </a>
