            ...
            <div class="center_column col-xs-12 col-sm-9" id="center_column">
                ...
                <div class="category-slider">
                    <ul class="owl-carousel owl-style2" data-dots="false" data-loop="true" data-nav = "true" data-autoplayTimeout="1000" data-autoplayHoverPause = "true" data-items="1">
                        <?php foreach($banner as $item){ /** @var \common\models\Slide $item */  ?>
                        <li>
                            <img style="height:288px;" src="<?= $item->getSlideImage() ?>" alt="<?= $item->id ?>">
                        </li>
                        <?php } ?>
                    </ul>
                </div>
                ...
                <div id="view-product-list" class="view-product-list">
                    ...
                    <ul class="row product-list grid">
                        <?php if(isset($content)){ ?>
                            <?php foreach($content as $item ){ /** @var Content $item */ ?>
                                <li class="col-sx-12 col-sm-4">
                                    <div class="left-block">
                                        <a href="<?= Url::to(['content/detail','id'=>$item->id]) ?>">
                                            <img style="height: 366px" class="img-responsive" alt="product" src="<?= $item->getFirstImageLinkFE() ?>" />
                                        </a>
