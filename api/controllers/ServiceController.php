...
//    }
    ...
    public function actionIndex($content_id=0){
        ...
        return ServiceGroup::getServiceGroup($this->site->id,$content_id,$subscriber);
    }

    public function actionHelpPurchase(){
        $temp = [];

        $temp[] = ['content'=>Message::MSG_HOW_TO_PURCHASE_CONTENT_SMS_CHANNEL,'type'=>1];
        $temp[] = ['content'=>Message::MSG_HOW_TO_PURCHASE_SERVICE_SMS_CHANNEL,'type'=>2];
        $temp[] = ['content'=>Message::MSG_HOW_TO_PURCHASE_COIN_SMS_CHANNEL,'type'=>3];
        $temp[] = ['content'=>Message::MSG_HOW_TO_LINK_PORTAL,'type'=>4];
        return $temp;
    }
